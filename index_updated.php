...
<body>
    ...
    <section id="home" class="hero" role="region" aria-label="Hero section">
        <div class="hero-content-full">
            <h1 class="hero-title" data-aos="fade-up">Your Personal Mental Health Companion</h1>
            <p class="hero-subtitle" data-aos="fade-up-delay">Free resources, 24/7 support, and expert guidance - all in one place</p>
            
            <!-- Quick Access Cards -->
            <div class="quick-access-grid" data-aos="fade-up-delay">
                <div class="quick-access-card">
                    <div class="qa-icon">🧠</div>
                    <h3>AI Mood Tracker</h3>
                    <p>Track your daily mood and get personalized insights</p>
                    <button class="btn btn-small">Start Tracking</button>
                </div>
                <div class="quick-access-card">
                    <div class="qa-icon">🧘</div>
                    <h3>Guided Meditations</h3>
                    <p>5-30 minute meditations for stress, anxiety, and sleep</p>
                    <button class="btn btn-small">Begin Now</button>
                </div>
                <div class="quick-access-card">
                    <div class="qa-icon">📓</div>
                    <h3>Journal</h3>
                    <p>Express your thoughts privately with AI-powered prompts</p>
                ...
                <div class="quick-access-card">
                    ...
                    <button class="btn btn-small">Join Community</button>
                </div>
            </div>
            
            <!-- Key Statistics -->
            <div class="hero-stats" data-aos="fade-up-delay">
                <div class="hero-stat-item">
                    <span class="hero-stat-number">50K+</span>
                    <span class="hero-stat-text">Active Users</span>
                </div>
                <div class="hero-stat-item">
                    <span class="hero-stat-number">10K+</span>
                    <span class="hero-stat-text">Journals Saved</span>
                </div>
                <div class="hero-stat-item">
                    <span class="hero-stat-number">1M+</span>
                    <span class="hero-stat-text">Meditations Completed</span>
                </div>
                <div class="hero-stat-item">
                    <span class="hero-stat-number">24/7</span>
                    <span class="hero-stat-text">Support Available</span>
                </div>
            </div>
            
            <!-- Main Features Section -->
            <div class="hero-features" data-aos="fade-up-delay-2">
                <h3 class="features-title">Everything You Need for Mental Wellness</h3>
                <div class="features-grid">
                    <div class="hero-feature">
                        <span class="hero-feature-icon">📊</span>
                        <div>
                            <strong>Mood Analytics</strong>
                            <small>Track patterns over time with beautiful charts and insights</small>
                        </div>
                    </div>
                    <div class="hero-feature">
                        <span class="hero-feature-icon">🎯</span>
                        <div>
                            ...
                            <small>Set and achieve mental wellness goals with daily reminders</small>
                        </div>
                    </div>
                    <div class="hero-feature">
                        <span class="hero-feature-icon">📱</span>
                        <div>
                            ...
                            <small>Quick morning and evening check-ins to monitor your wellbeing</small>
                        </div>
                    </div>
                    <div class="hero-feature">
                        <span class="hero-feature-icon">🔒</span>
                        <div>
                            ...
                            <small>Your data is encrypted and never shared with anyone</small>
                        </div>
                    </div>
                    <div class="hero-feature">
                        <span class="hero-feature-icon">💬</span>
                        <div>
                            ...
                            <small>Chat anytime for emotional support and coping strategies</small>
                        </div>
                    </div>
                    <div class="hero-feature">
                        <span class="hero-feature-icon">📚</span>
                        <div>
                            ...
                            <small>Access 500+ articles, videos, and self-help guides</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Benefits Section -->
            <div class="benefits-section" data-aos="fade-up-delay-2">
                <h3 class="benefits-title">Why Use MindCare Dashboard?</h3>
                <div class="benefits-grid">
                    <div class="benefit-card">
                        <div class="benefit-icon">🌟</div>
                        <h4>Track Daily Mood</h4>
                        <p>Record your emotions multiple times a day and identify triggers that affect your mental health</p>
                    </div>
                    <div class="benefit-card">
                        <div class="benefit-icon">📈</div>
                        <h4>See Patterns</h4>
                        <p>Understand how sleep, exercise, and activities impact your mood through visual charts</p>
                    </div>
                    <div class="benefit-card">
                        <div class="benefit-icon">🎯</div>
                        <h4>Set Goals</h4>
                        <p>Create achievable wellness goals like meditation streaks, sleep targets, and exercise plans</p>
                    </div>
                    <div class="benefit-card">
                        <div class="benefit-icon">💡</div>
                        <h4>Get Insights</h4>
                        <p>Receive personalized recommendations based on your mood patterns and journal entries</p>
                    </div>
                    <div class="benefit-card">
                        <div class="benefit-icon">🧘</div>
                        <h4>Guided Exercises</h4>
                        <p>Access 50+ guided meditations for anxiety, stress, focus, and better sleep</p>
                    </div>
                    <div class="benefit-card">
                        <div class="benefit-icon">📝</div>
                        <h4>Journaling</h4>
                        <p>Write freely with AI prompts that help you reflect and process emotions</p>
                    </div>
                    <div class="benefit-card">
                        <div class="benefit-icon">🔔</div>
                        <h4>Reminders</h4>
                        <p>Never miss a check-in with customizable daily reminders for mood tracking</p>
                    </div>
                    <div class="benefit-card">
                        <div class="benefit-icon">🏆</div>
                        <h4>Achievements</h4>
                        <p>Earn badges and celebrate milestones in your mental wellness journey</p>
                    </div>
                </div>
            </div>
            
            <!-- How It Works Section -->
            <div class="how-it-works" data-aos="fade-up-delay-2">
                ...
                <div class="steps-container">
                    <div class="step-item">
                        ...
                        <div class="step-content">
                            ...
                            <p>Take 30 seconds each morning and evening to record how you feel</p>
                        </div>
                    </div>
                    <div class="step-item">
                        ...
                        <div class="step-content">
                            ...
                            <p>Log sleep, exercise, meals, and activities that affect your mood</p>
                        </div>
                    </div>
                    <div class="step-item">
                        ...
                        <div class="step-content">
                            <h4>View Insights</h4>
                            <p>See your mood patterns and get personalized tips to improve wellbeing</p>
                        </div>
                    </div>
                    <div class="step-item">
                        ...
                        <div class="step-content">
                            <h4>Build Habits</h4>
                            <p>Set goals, earn achievements, and develop healthy mental wellness habits</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Quick Tips Section -->
            <div class="quick-tips-section" data-aos="fade-up-delay-3">
                <h3 class="tips-title">Quick Wellness Tips</h3>
                <div class="tips-grid">
                    <div class="tip-card">
                        <span class="tip-icon">🌬️</span>
                        <div>
                            <strong>Deep Breathing</strong>
                            <p>Try 4-7-8 breathing: Inhale 4s, hold 7s, exhale 8s</p>
                        </div>
                    </div>
                    <div class="tip-card">
                        ...
                        <div>
                            ...
                            <p>Just 15 minutes of walking can reduce anxiety significantly</p>
                        </div>
                    </div>
                    <div class="tip-card">
                        <span class="tip-icon">😴</span>
                        <div>
                            ...
                            <p>Maintain consistent sleep times for better mental health</p>
                        </div>
                    </div>
                    <div class="tip-card">
                        <span class="tip-icon">📵</span>
                        <div>
                            ...
                            <p>Take 1 hour screen-free time before bed for better sleep</p>
                        </div>
                    </div>
                    <div class="tip-card">
                        <span class="tip-icon">💧</span>
                        <div>
                            ...
                            <p>Drink 8 glasses of water daily for optimal brain function</p>
                        </div>
                    </div>
                    <div class="tip-card">
                        <span class="tip-icon">🤝</span>
                        <div>
                            ...
                            <p>Connect with at least one person daily for better wellbeing</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Call to Action -->
            <div class="hero-buttons" data-aos="fade-up-delay-3">
            ...
            <!-- Trust Indicators -->
            <div class="trust-indicators" data-aos="fade-up-delay-3">
                ...
                <span class="trust-item">✓ Doctor Verified</span>
            </div>
            
            <!-- Floating Data Cards with Animated Circles -->
            <div class="hero-floating-data">
                ...
                <div class="float-data-card float-card-1">
                    <span class="fdc-value">300M+</span>
                    <span class="fdc-label">People Affected</span>
                </div>
                <div class="float-data-card float-card-2">
                    <span class="fdc-value">90%</span>
                    <span class="fdc-label">Untreated</span>
                </div>
                <div class="float-data-card float-card-3">
                    <span class="fdc-value">1:100K</span>
                    <span class="fdc-label">Doctor Ratio</span>
                </div>
                <div class="float-data-card float-card-4">
                    <span class="fdc-value">80%</span>
                    <span class="fdc-label">No Access</span>
                </div>
            </div>
        </div>
    </section>
